        ...
        headers: [
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://platform.twitter.com https://platform.x.com",
              "style-src 'self' 'unsafe-inline'",
              "img-src 'self' data: https: https://pbs.twimg.com https://abs.twimg.com https://*.fbcdn.net https://scontent-*.fbcdn.net",
